...
class Point2D(metaclass=Metaclass_Point2D):
    ...
    def __init__(self, **kwargs):
        ...
        self.alreadyinside = kwargs.get('alreadyinside', bool())
    ...
    def __eq__(self, other):
        ...
        if self.inside != other.inside:
            return False
        if self.alreadyinside != other.alreadyinside:
            return False
        return True
    ...
    @builtins.property
    def alreadyinside(self):
        """Message field 'alreadyinside'."""
        return self._alreadyinside

    @alreadyinside.setter
    def alreadyinside(self, value):
        if __debug__:
            assert \
                isinstance(value, bool), \
                "The 'alreadyinside' field must be of type 'bool'"
        self._alreadyinside = value
