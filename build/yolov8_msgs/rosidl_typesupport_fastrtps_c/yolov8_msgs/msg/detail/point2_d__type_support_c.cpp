  ...
  eprosima::fastcdr::Cdr & cdr)
{
  ...
  // Field name: alreadyinside
  {
    cdr << (ros_message->alreadyinside ? true : false);
  }
  ...
  void * untyped_ros_message)
{
  ...
  // Field name: alreadyinside
  {
    uint8_t tmp;
    cdr >> tmp;
    ros_message->alreadyinside = tmp ? true : false;
  }
  ...
  size_t current_alignment)
{
  ...
  // field.name alreadyinside
  {
    size_t item_size = sizeof(ros_message->alreadyinside);
    current_alignment += item_size +
      eprosima::fastcdr::Cdr::alignment(current_alignment, item_size);
  }
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = yolov8_msgs__msg__Point2D;
    is_plain =
      (
      offsetof(DataType, alreadyinside) +
      last_member_size
      ) == ret_val;
  }
